...
def validate_example(module: TofuModule) -> None:
    ...
    arguments = [
        ...
        "validate",
        "-no-color",
        *module.var_arguments(module.validate_vars),
    ]
    run_tool(
        TOFU,
        arguments,
...
def plan_example(module: TofuModule) -> None:
...
def main(*, module: typ.Annotated[str, Parameter(required=True)]) -> None:
    ...
    validate_example(configuration)
    plan_example(configuration)
